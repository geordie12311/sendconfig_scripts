#python script utilising nornir_scrapli plugin send_config
#script will send configuration command listed in the task.run
#i.e. config="xxxxxxx" to each host in nornir host file
